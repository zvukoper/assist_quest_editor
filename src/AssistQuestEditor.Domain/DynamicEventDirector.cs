...
/// </summary>
public interface IDynamicEventDirector : IDisposable
{
...
/// </summary>
public sealed class DynamicEventDirector : IDynamicEventDirector
{
    ...
    public void SetSimulationRunning(bool running)
    {
        ...
        Publish(
            running ? "DynamicEventDirectorStarted" : "DynamicEventDirectorStopped",
    ...
    public void Reset()
    {
        ...
        Publish("DynamicEventDirectorReset", "Система генерации динамических событий сброшена.");
    }
    ...
    private void InitializeFromCurrentWorld()
    {
        ...
        WriteState(State.Instances, schedules, "DynamicEventDirector.Initialize");
    }
        ...
        Func<DynamicEventInstance, DynamicEventInstance> mutator)
    {
        ...
        WriteState(current, State.Schedules, "DynamicEventDirector.Transition");
    ...
    private void HubEvent_Published(SimulatorEvent e)
    {
        ...
        if (e.Source.Equals("DynamicEventDirector", StringComparison.OrdinalIgnoreCase))
            return;
        ...
        WriteState(
            State.Instances,
            schedules.Values.OrderBy(item => item.DefinitionId, StringComparer.OrdinalIgnoreCase).ToArray(),
            "DynamicEventDirector.WorldEvent");
    }
        ...
        WorldPoint? point = null)
    {
        ...
        var e = new SimulatorEvent(eventType, DateTimeOffset.UtcNow, "DynamicEventDirector", payload);
    ...
    {
        if (_disposed)
            throw new ObjectDisposedException(nameof(DynamicEventDirector));
    }
