...
public static class ResourceFileTypes
{
    ...
    [
        ...
        new(".aqchoice", "Choice", "Assist Quest Choice", "Choice", "aqchoice.ico", "choice.aqchoice", "Переиспользуемый ресурс выбора и его вариантов."),
        ...
        new(".aqworld", "World", "Assist Quest World", "World", "aqworld.ico", "world.aqworld", "Авторский контейнер пространственных данных мира."),
        ...
        new(".aqcondition", "Condition", "Assist Quest Condition", "Condition", "aqcondition.ico", "condition.aqcondition", "Переиспользуемое условие логики."),
        new(".aqeffect", "Effect", "Assist Quest Effect", "Effect", "aqeffect.ico", "effect.aqeffect", "Переиспользуемое игровое действие/эффект."),
