...
/// <summary>
/// Правки списка перекрёстков в виде координат.
///
    ...
    IReadOnlyList<JunctionPoint> Added)
{
    ...
    public IReadOnlyList<JunctionPoint> Apply(IReadOnlyList<JunctionPoint> detected)
    {
        ...
        {
            // Добавленный узел может совпасть с уже найденным (автор добавил то,
            // что поиск всё-таки нашёл) — тогда дубликат не нужен.
