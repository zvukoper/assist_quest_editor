...
Метод B даёт 96 из 97 размеченных вручную узлов (в 30 м), медиана смещения 9 м; метод A их не находил. Результаты объединяются, чтобы настоящие пересечения координат не потерялись.
